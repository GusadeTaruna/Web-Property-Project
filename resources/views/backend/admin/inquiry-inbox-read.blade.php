            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                    ...
                    <div>
                        <h5 class="mb-2"><span style="font-weight: bold">Email from :</span> {{ $messages->sender_name }} ({{ $messages->sender_email }})</h5>
                    </div>
                    <div>
                        <h5 class="mb-5"><span style="font-weight: bold">Inquiry List :</span> {{ $messages->inquiry_list }}</h5>
                    </div>
