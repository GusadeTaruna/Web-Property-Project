                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="article_title" class="form-control @error('article_title') is-invalid @enderror" id="article_title" placeholder="Input article title here" value="{{$data->blog_title}}" required>
                                @error('article_title')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="article_category" class="form-control @error('article_category') is-invalid @enderror" id="article_category" placeholder="Input article category here" value="{{$data->blog_category}}" required>
