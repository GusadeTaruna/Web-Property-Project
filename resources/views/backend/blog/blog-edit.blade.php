                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea hidden name="article_content" class="form-control @error('article_content') is-invalid @enderror" id="open-source-plugins" placeholder="Input article content here">{{$data->blog_content}}</textarea>
