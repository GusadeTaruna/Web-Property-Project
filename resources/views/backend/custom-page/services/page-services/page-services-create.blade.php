...
@section('title', 'Customize Services Page')
        ...
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              @if (!$value)
              <form action="/admin/customize/services/create/page" method="post" enctype="multipart/form-data">
                @csrf
              ...
              @else
              <form action="{{ url('/admin/customize/services/update/page/'.$value['id'] ) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="col-md-12">
